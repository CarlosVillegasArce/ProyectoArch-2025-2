...
set_property PACKAGE_PIN T1 [get_ports {ALUControl[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ALUControl[0]}]
set_property PACKAGE_PIN R2 [get_ports {ALUControl[1]}]					
...
set_property PACKAGE_PIN V14 [get_ports {ALUFlags[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ALUFlags[0]}]
set_property PACKAGE_PIN V13 [get_ports {ALUFlags[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ALUFlags[1]}]
set_property PACKAGE_PIN V3 [get_ports {ALUFlags[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ALUFlags[2]}]
set_property PACKAGE_PIN W3 [get_ports {ALUFlags[3]}]					
